...
/**
 * script se encarga de ser el punto de relacion con el servidor/cliente y con Unity/interfaz
...
public class GameManager : MonoBehaviour
{
    ...
    public Text Marcador_Final;
    public Text Ganador;


    /**
     * Valida los eventos que se ocacionan en la interfaz y el en servidor 
     */    
    ...
    /**
     * Inicializa las funciones del script que conecta todos los personajes y objetos  
     */ 
    void Start()
    {
        NumJugadores = 0;
    ...
    void Update()
    {
        if (start == true)
        {
            if (TiempoInt == 160 || NumJugadores < 2)
            {
                gameOver = true;
                start = true;
            }
        ...
        {
            String Score_Final = NomRey.text +": "+ PuntajeRey.text + "\n" +NomBlue.text+": "+PuntajeBlue.text+"\n"+NomPink.text+": "+PuntajePink.text+"\n"+NomFrog.text+": "+PuntajeFrog.text;
            Marcador_Final.text = Score_Final.ToString();
    ...
    /**
     * Valida los puntajes guardados para generar un ganador
     */
    private void Score_final()
    {
        int R = int.Parse(PuntajeRey.text);
        int B = int.Parse(PuntajeBlue.text);
        int P = int.Parse(PuntajePink.text);
        int F = int.Parse(PuntajeFrog.text);
    ...
    /**
    * Colisiones de los jugadores con los objetos u otros personajes de lainterfaz
    */
